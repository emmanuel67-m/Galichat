        ...
        <div className="w-full h-full flex-grow flex flex-col">
          ...
          <div className="mt-24 max-w-full md:w-full h-[550px] rounded-lg overflow-hidden mx-auto">
            <img
              ...
              src="https://raw.githubusercontent.com/creativetimofficial/public-assets/refs/heads/master/gali/solutions/thumbs/ai-agent-book-authors.jpg"
        ...
        <div className="container mx-auto grid grid-cols-1 gap-12 md:grid-cols-2">
          ...
          <div className="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
            ...
            <div className="w-full h-max rounded p-0 text-center">
              ...
              <p className="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">
                Provide your website URL, upload product details, FAQs, and shipping information to ensure your AI Agent
                delivers precise and accurate responses.
              </p>
            </div>
          </div>
          <div className="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
      ...
      <section className="py-16 space-y-16 bg-neutral-100">
          ...
          <div className="w-full items-center p-12">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex items-start mb-4">
                ...
                <span className="text-neutral-500">
                  <span className="font-semibold text-neutral-900">Personalized Recommendations: </span> It can suggest
                  specific books or related content, helping them discover more of your work or similar titles.
                </span>
              </div>
              <div className="flex items-start mb-4">
                <div className="rounded-full bg-neutral-800 p-1 mr-3">
        ...
        <div className="container mx-auto grid items-center gap-y-8 md:grid-cols-2">
          <div className="w-full items-center p-12 md:row-start-1 row-start-2">
            ...
            <h3 className="font-sans antialiased font-extrabold text-2xl md:text-3xl lg:text-4xl text-neutral-950 mb-2">
              Gain More Leads Grow Sales
            </h3>
            <p className="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500">
              {" "}
              By interacting with potential buyers in real time, it collects valuable contact information and guides
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex items-start mb-4">
                ...
                <span className="text-neutral-500">
                  <span className="font-semibold text-neutral-900">Seamless Sales Funnel Integration:</span> It directs
                  potential buyers to your book's sales page, provides purchase links, and even offers one-click access
                  to a free preview or demo to encourage conversions.
                </span>
              </div>
              <div className="flex items-start mb-4">
                <div className="rounded-full bg-neutral-800 p-1 mr-3">
        ...
        <div className="container mx-auto grid items-center gap-y-8 md:grid-cols-2">
          <img
            src="https://raw.githubusercontent.com/creativetimofficial/public-assets/refs/heads/master/gali/solutions/shopify-ai-agent.jpg"
            alt="image"
          ...
          <div className="w-full items-center p-12">
            ...
            <p className="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500">
              Once you create your AI Agent, you'll have access to a unique link that you can share across multiple
              platforms.
            </p>
            <div className="flex flex-col space-y-4">
              <div className="flex items-start">
      ...
      <section className="py-16 bg-neutral-100">
        <div className="h-max rounded p-6 w-full m-0 text-center">
          ...
          <p className="font-sans antialiased text-base md:text-lg text-neutral-500 max-w-3xl [text-wrap:balance] mx-auto mb-4">
            Just enter your store URL, upload your product details and FAQs, personalize your AI assistant, and add a
            simple code snippet to your website. That's it—quick, seamless, and hassle-free!
          </p>
        </div>
        ...
        <div className="container mx-auto grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-3">
          <div className="w-full rounded-lg border shadow-sm overflow-hidden border-transparent shadow-transparent bg-transparent">
            <div className="w-full h-max rounded p-0 text-center">
              ...
              <div className="inline-flex items-center w-5 :h-5 cursor-pointer text-amber-500">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
          ...
          <div className="w-full rounded-lg border shadow-sm overflow-hidden border-transparent shadow-transparent bg-transparent">
            <div className="w-full h-max rounded p-0 text-center">
              ...
              <div className="inline-flex items-center w-5 h-5 text-inherit cursor-pointer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
