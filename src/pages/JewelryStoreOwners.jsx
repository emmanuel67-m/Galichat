...
function Discoverpage() {
  ...
  <div class="w-full h-full flex-grow flex flex-col">
    ...
    <div class="container h-full relative flex-grow flex justify-center flex-col items-center text-center z-10 py-8 md:py-16 lg:py-24 mx-auto">
      ...
      <p class="font-sans antialiased text-base md:text-lg lg:text-xl text-white/80 font-normal max-w-4xl mx-auto">ZenChat is your 24/7 AI-powered assistant designed to help jewelry store owners automate customer interactions, boost engagement, and drive more sales effortlessly.</p>
...
<section class="py-16 bg-neutral-950">
  <div class="container mx-auto mb-12 text-center">
    ...
    <p class="font-sans antialiased text-base md:text-lg max-w-2xl text-white/60 mx-auto">ZenChat streamlines customer interactions, making it easier to connect with potential buyers and promote your collections.</p>
  </div>
  <div class="container mx-auto grid grid-cols-1 gap-12 md:grid-cols-2">
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent text-center">
      ...
      <div class="w-full h-max rounded p-0">
        ...
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">No complex setup required—just add a simple script to your jewelry website, and ZenChat is instantly ready to assist customers, answer questions, and enhance their shopping experience.</p>
      </div>
    </div>
    ...
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
      ...
      <div class="w-full h-max rounded p-0 text-center">
        ...
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">Customize ZenChat to match your brand’s voice and communication style, offering a natural and engaging interaction with your customers.</p>
      </div>
    </div>
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
      <div class="h-max rounded m-2 w-full mx-0 mt-0 mb-4">
      ...
      <div class="w-full h-max rounded p-0 text-center">
        ...
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">ZenChat delivers instant answers on product details, pricing, and availability, keeping customers engaged and increasing conversion rates.</p>
      </div>
</div></div></section>
...
<section class="py-16 space-y-16 bg-neutral-100">
  <div class="container mx-auto grid items-center gap-y-8 md:grid-cols-2">
    ...
    <div class="w-full items-center p-12">
      ...
      <p class="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500">ZenChat engages visitors and guides them to purchase with recommendations and easy access to links or promotions.
  ...
  <div class="container mx-auto grid items-center gap-y-8 md:grid-cols-2">
    <div class="w-full items-center p-12 md:row-start-1 row-start-2">
      ...
      <p class="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500">Convert website visitors into loyal customers with ZenChat's lead collection and sales-boosting features.
        </p><div class="flex flex-col space-y-4">
          <div class="flex items-start">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
  ...
  <div class="container mx-auto grid items-center gap-y-8 md:grid-cols-2">
    ...
    <div class="w-full items-center p-12">
      ...
      <p class="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500">With ZenChat, connecting with your audience is simple. Share your AI assistant across platforms to drive more traffic to your store.
        </p><div class="flex flex-col space-y-4">
          <div class="flex items-start">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Instant Access, No Installation Needed:</span> Share your ZenChat link on social media, your website, or newsletters, allowing customers to interact without downloads.</span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
