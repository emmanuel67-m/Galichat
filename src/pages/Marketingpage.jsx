...
function Discoverpage() {
  ...
  <div class="w-full h-full flex-grow flex flex-col">
    ...
    <div class="mt-24 max-w-full md:w-full h-[550px] rounded-lg overflow-hidden mx-auto">
      <img class="absolute z-10 rounded-xl -translate-x-1/2 left-1/2 -mt-12 w-full max-w-[740px] lg:w-1/2 shadow-2xl" src="https://raw.githubusercontent.com/creativetimofficial/public-assets/refs/heads/master/gali/solutions/thumbs/ai-agent-jewelry-store-owners.jpg" alt="marketing ai agent"></img>
    </div>
  </div>
</header>
  ...
  <div class="container mx-auto grid grid-cols-1 gap-12 md:grid-cols-2">
    ...
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
      ...
      <div class="w-full h-max rounded p-0 text-center">
        <h6 class="font-sans antialiased font-bold text-base md:text-lg lg:text-xl text-white mb-2">
          AI-Driven Personalization</h6>
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">Customize responses, tone, and messaging to reflect your brand`s voice and create meaningful customer interactions.</p>
      </div>
    </div>
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
      <div class="h-max rounded m-2 w-full mx-0 mt-0 mb-4">
      ...
      <div class="w-full h-max rounded p-0 text-center">
        <h6 class="font-sans antialiased font-bold text-base md:text-lg lg:text-xl text-white mb-2">
          Real-Time Customer Support</h6>
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">Deliver instant, relevant responses to inquiries, reducing bounce rates and improving user experience.</p>
      </div>
    </div>
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
      <div class="h-max rounded m-2 w-full mx-0 mt-0 mb-4">
...
<section class="py-16 space-y-16 bg-neutral-100">
    ...
    <div class="w-full items-center p-12">
      ...
      <p class="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500">ZenChat goes beyond chat support—it actively nurtures leads, collects customer data, and drives sales by offering personalized recommendations and strategic promotions.
          ...
          <div class="flex items-start">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Promote Webinars &amp; Events:</span> Automatically inform visitors about upcoming launches, webinars, and industry events to boost attendance.</span>
          </div>
          <div class="flex items-start mb-4">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">AI-Powered Recommendations: </span> Suggest products, services, or content based on customer behavior and preferences.</span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Exclusive Offers &amp; Discounts: </span> Deliver personalized promotions, limited-time deals, and loyalty incentives to increase conversions.</span>
          </div>
        </div>
      <p></p>
      <div class="mb-6"></div>
    ...
    <div class="w-full items-center p-12 md:row-start-1 row-start-2">
      ...
      <p class="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500"> ZenChat helps businesses generate high-quality leads to turn them into customers effortlessly.
          ...
          <div class="flex items-start">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Automated Lead Collection: </span>Capture visitor details, such as names and emails, for seamless follow-ups.</span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Intelligent Sales Funnel Integration:</span> Guide potential customers to product pages, sign-up forms, and checkout links for higher conversion rates.
            </span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Upselling &amp; Cross-Selling: </span> Increase revenue by suggesting complementary products, upgrades, or premium offers based on user interest.</span>
          </div>
        </div>
      <p></p>
      <div class="mb-6"></div>
  ...
  <div class="container mx-auto grid items-center gap-y-8 md:grid-cols-2">
    <img src="https://raw.githubusercontent.com/creativetimofficial/public-assets/refs/heads/master/gali/solutions/share-ai-agent.jpg" alt="marketing community agent" class="max-w-full h-auto w-full rounded-lg object-center object-cover border border-neutral-200"></img>
    <div class="w-full items-center p-12">
      <div class="border shadow-sm overflow-hidden bg-neutral-900 border-neutral-950 shadow-neutral-950/25 w-12 h-12 text-white mb-8 rounded-lg grid place-items-center p-2">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
      ...
      <h3 class="font-sans antialiased font-extrabold text-2xl md:text-3xl lg:text-4xl text-neutral-950 mb-2">
        Expand Your Reach &amp; Build Brand Awareness</h3>
      <p class="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500">Share your AI-powered assistant anywhere to drive interaction and customer action.
        </p><div class="flex flex-col space-y-4">
          <div class="flex items-start">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div class="flex items-start mb-4">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Effortless Audience Engagement:</span> Keep your customers informed and connected with automated updates, promotions, and insights.</span>
          </div>
        </div>
      <p></p>
      <div class="mb-6"></div>
...
<section class="py-16 bg-neutral-100">
  <div class="h-max rounded p-6 w-full m-0 text-center">
    <h1 class="font-sans antialiased font-extrabold text-2xl md:text-3xl lg:text-4xl text-neutral-950 mb-1 mt-4">
      Simple &amp; Fast Setup</h1>
    <p class="font-sans antialiased text-base md:text-lg text-neutral-500 max-w-3xl [text-wrap:balance] mx-auto mb-4">
      
  Launch your AI-powered marketing assistant in minutes—just enter your website URL, upload relevant content, customize your AI, and embed a simple code snippet. No hassle, no technical expertise needed!</p>
  </div>
