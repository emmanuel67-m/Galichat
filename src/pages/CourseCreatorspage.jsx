  ...
  <div class="w-full h-full flex-grow flex flex-col">
    ...
    <div class="container h-full relative flex-grow flex justify-center flex-col items-center text-center z-10 py-8 md:py-16 lg:py-24 mx-auto">
      ...
      <h1 class="font-sans antialiased font-extrabold text-3xl md:text-4xl lg:text-5xl text-white mt-6 mb-4 !leading-[1.125]">
        The Ultimate AI Agent for Course Creators</h1>
      <p class="font-sans antialiased text-base md:text-lg lg:text-xl text-white/80 font-normal max-w-4xl mx-auto">Whether you're an online educator, course creator, or membership site owner, GaliChat ensures no student question goes unanswered.</p>
    ...
    <div class="mt-24 max-w-full md:w-full h-[550px] rounded-lg overflow-hidden mx-auto">
      <img class="absolute z-10 rounded-xl -translate-x-1/2 left-1/2 -mt-12 w-full max-w-[740px] lg:w-1/2 shadow-2xl" src="https://raw.githubusercontent.com/creativetimofficial/public-assets/refs/heads/master/gali/solutions/thumbs/ai-agent-course-creators.jpg" alt="ai agent for course creators"></img>
    </div>
  </div>
</header>
...
<section class="py-16 bg-neutral-950">
  <div class="container mx-auto mb-12 text-center">
    ...
    <h2 class="font-sans antialiased font-bold text-2xl md:text-3xl lg:text-4xl text-white my-4">
      Why Course Creators Love GaliChat</h2>
    <p class="font-sans antialiased text-base md:text-lg max-w-2xl text-white/60 mx-auto">GaliChat automates student interactions, providing real-time support and guidance without requiring extra effort from you. </p>
  </div>
  <div class="container mx-auto grid grid-cols-1 gap-12 md:grid-cols-2">
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent text-center">
      ...
      <div class="w-full h-max rounded p-0">
        <h6 class="font-sans antialiased font-bold text-base md:text-lg lg:text-xl text-white mb-2">
          Quick &amp; Easy Setup</h6>
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">No tech headaches—just embed a simple script on your course website, and GaliChat is ready to assist your students instantly.</p>
      </div>
    </div>
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
      ...
      <div class="w-full h-max rounded p-0 text-center">
        ...
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">Train your AI assistant with course details, pricing, FAQs, and learning materials so it delivers accurate and helpful responses every time.</p>
      </div>
    </div>
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
      <div class="h-max rounded m-2 w-full mx-0 mt-0 mb-4">
      ...
      <div class="w-full h-max rounded p-0 text-center">
        ...
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">Adjust GaliChat`s tone and style to reflect your unique teaching approach, ensuring an engaging and authentic student experience.</p>
      </div>
    </div>
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
      <div class="h-max rounded m-2 w-full mx-0 mt-0 mb-4">
      ...
      <div class="w-full h-max rounded p-0 text-center">
        <h6 class="font-sans antialiased font-bold text-base md:text-lg lg:text-xl text-white mb-2">
          Instant Support for Students</h6>
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">Whether visitors want to learn about your courses, enroll in a program, or access resources, GaliChat provides instant guidance—keeping them engaged and reducing drop-offs.</p>
      </div>
</div></div></section>
...
<section class="py-16 space-y-16 bg-neutral-100">
  <div class="container mx-auto grid items-center gap-y-8 md:grid-cols-2">
    ...
    <div class="w-full items-center p-12">
      ...
      <p class="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500">GaliChat does more than just answer questions—it nurtures leads and encourages students to take action.
          ...
          <div class="flex items-start">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Promote Your Webinars &amp; Live Sessions:</span> GaliChat can invite visitors to your upcoming live workshops, Q&amp;A sessions, or masterclasses.</span>
          </div>
          <div class="flex items-start mb-4">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Recommend the Right Courses: </span> Based on student interests, it suggests the most relevant courses, memberships, or learning paths.</span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Offer Free Resources &amp; Lead Magnets: </span> Drive sign-ups by providing free ebooks, mini-courses, or trial lessons to build trust before students commit.</span>
          </div>
        </div>
      <p></p>
      <div class="mb-6"></div>
  ...
  <div class="container mx-auto grid items-center gap-y-8 md:grid-cols-2">
    <div class="w-full items-center p-12 md:row-start-1 row-start-2">
      ...
      <h3 class="font-sans antialiased font-extrabold text-2xl md:text-3xl lg:text-4xl text-neutral-950 mb-2">
        Gain More Leads &amp; Grow Sales</h3>
      <p class="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500">Beyond answering inquiries, GaliChat helps you capture leads to convert them into paying students.
        </p><div class="flex flex-col space-y-4">
          <div class="flex items-start">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Automated Lead Collection: </span>Collects visitor names and emails so you can follow up with course offers, newsletters, or special promotions.</span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Seamless Enrollment Integration:</span> Directs students to your checkout or registration page for easy course sign-ups.
            </span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Smart Upselling: </span> Suggests additional courses, memberships, or premium learning experiences to increase revenue.</span>
          </div>
        </div>
      <p></p>
      <div class="mb-6"></div>
  ...
  <div class="container mx-auto grid items-center gap-y-8 md:grid-cols-2">
    <img src="https://raw.githubusercontent.com/creativetimofficial/public-assets/refs/heads/master/gali/solutions/share-ai-agent.jpg" alt="course community agent" class="max-w-full h-auto w-full rounded-lg object-center object-cover border border-neutral-200"></img>
    <div class="w-full items-center p-12">
      <div class="border shadow-sm overflow-hidden bg-neutral-900 border-neutral-950 shadow-neutral-950/25 w-12 h-12 text-white mb-8 rounded-lg grid place-items-center p-2">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
      ...
      <h3 class="font-sans antialiased font-extrabold text-2xl md:text-3xl lg:text-4xl text-neutral-950 mb-2">
        Share AI Agent Anywhere &amp; Everywhere</h3>
      <p class="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500">Your AI assistant isn’t just for your website—it can be shared across multiple platforms for effortless student engagement.
        </p><div class="flex flex-col space-y-4">
          <div class="flex items-start">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Instant Access, No Installation:</span>  Share your AI assistant via social media, email, or SMS so potential students can interact anytime.</span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Perfect for Learning Communities:</span> Share it in Facebook groups, discussion forums, or online communities to boost engagement and answer questions instantly.</span>
          </div>
        </div>
      <p></p>
      <div class="mb-6"></div>
...
<section class="py-16 bg-neutral-100">
  ...
  Just enter your course website URL, upload course details and FAQs, personalize your AI assistant, and add a simple code snippet to your site. That's it—quick, seamless, and hassle-free!</p>
  </div>
