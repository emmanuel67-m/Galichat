  ...
  <div class="w-full h-full flex-grow flex flex-col">
    ...
    <div class="container h-full relative flex-grow flex justify-center flex-col items-center text-center z-10 py-8 md:py-16 lg:py-24 mx-auto">
      ...
      <h1 class="font-sans antialiased font-extrabold text-3xl md:text-4xl lg:text-5xl text-white mt-6 mb-4 !leading-[1.125]">
        Best AI Agent for Entrepreneurs</h1>
      <p class="font-sans antialiased text-base md:text-lg lg:text-xl text-white/80 font-normal max-w-4xl mx-auto">GaliChat is your AI Agent designed to generate leads &amp; streamline communication. Whether you're a startup founder, e-commerce seller, or service provider, GaliChat helps you scale.</p>
    ...
    <div class="mt-24 max-w-full md:w-full h-[550px] rounded-lg overflow-hidden mx-auto">
      <img class="absolute z-10 rounded-xl -translate-x-1/2 left-1/2 -mt-12 w-full max-w-[740px] lg:w-1/2 shadow-2xl" src="https://raw.githubusercontent.com/creativetimofficial/public-assets/refs/heads/master/gali/solutions/thumbs/ai-agent-jewelry-store-owners.jpg" alt="ai agent for entrepreneurs"></img>
    </div>
  </div>
</header>
...
<section class="py-16 bg-neutral-950">
  <div class="container mx-auto mb-12 text-center">
    <p class="font-sans antialiased text-base text-white font-semibold">AI Agent Features</p>
    <h2 class="font-sans antialiased font-bold text-2xl md:text-3xl lg:text-4xl text-white my-4">
      Why Entrepreneurs Love GaliChat</h2>
    <p class="font-sans antialiased text-base md:text-lg max-w-2xl text-white/60 mx-auto">As an entrepreneur, every minute counts. GaliChat handles customer inquiries, collects leads, and gives product recommendations, letting you focus on what matters most—building your business. </p>
  </div>
  <div class="container mx-auto grid grid-cols-1 gap-12 md:grid-cols-2">
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent text-center">
      ...
      <div class="w-full h-max rounded p-0">
        <h6 class="font-sans antialiased font-bold text-base md:text-lg lg:text-xl text-white mb-2">
          Fast &amp; Easy Setup</h6>
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">No coding needed—just add a simple script to your website, and GaliChat is ready to start engaging with customers instantly.</p>
      </div>
    </div>
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
      ...
      <div class="w-full h-max rounded p-0 text-center">
        <h6 class="font-sans antialiased font-bold text-base md:text-lg lg:text-xl text-white mb-2">
          Many Training Options</h6>
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">Train your AI assistant with product details, service offerings, pricing, and FAQs to provide accurate, on-brand responses automatically.</p>
      </div>
    </div>
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
      <div class="h-max rounded m-2 w-full mx-0 mt-0 mb-4">
      ...
      <div class="w-full h-max rounded p-0 text-center">
        <h6 class="font-sans antialiased font-bold text-base md:text-lg lg:text-xl text-white mb-2">
          Customizable for Any Business</h6>
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">Whether you run an e-commerce store, a coaching business, or a consulting firm, GaliChat adapts to your unique needs with personalized responses and a tailored tone.</p>
      </div>
    </div>
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
      <div class="h-max rounded m-2 w-full mx-0 mt-0 mb-4">
      ...
      <div class="w-full h-max rounded p-0 text-center">
        <h6 class="font-sans antialiased font-bold text-base md:text-lg lg:text-xl text-white mb-2">
          Instant Customer Support</h6>
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">No more delays—GaliChat provides real-time answers to inquiries about your products, services, and offers, ensuring higher engagement and lower bounce rates.</p>
      </div>
</div></div></section>
...
<section class="py-16 space-y-16 bg-neutral-100">
  <div class="container mx-auto grid items-center gap-y-8 md:grid-cols-2">
    ...
    <div class="w-full items-center p-12">
      ...
      <p class="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500">GaliChat does more than just support; it can provide links to your purchase pages  making it easier for potential buyers to take the next step.
          ...
          <div class="flex items-start">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Promote Special Offers &amp; Events: </span>  Whether it`s a product launch, webinar, or limited-time discount, GaliChat ensures your audience never misses an opportunity.</span>
          </div>
          <div class="flex items-start mb-4">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Recommend Products &amp; Services: </span> It can suggest best-selling products, tailored services, or upsell premium packages based on visitor interests.</span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Exclusive Offers: </span> GaliChat can offer discount codes, limited-time deals, helping you build a stronger connection with potential readers.</span>
          </div>
        </div>
      <p></p>
      <div class="mb-6"></div>
  ...
  <div class="container mx-auto grid items-center gap-y-8 md:grid-cols-2">
    <div class="w-full items-center p-12 md:row-start-1 row-start-2">
      ...
      <h3 class="font-sans antialiased font-extrabold text-2xl md:text-3xl lg:text-4xl text-neutral-950 mb-2">
        More Leads, More Sales, More Growth</h3>
      <p class="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500"> By interacting with potential buyers in real time, it collects valuable contact information and guides them toward making a purchase.
        </p><div class="flex flex-col space-y-4">
          <div class="flex items-start">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Automated Lead Capture: </span>Gathers visitor names, emails, and preferences, making follow-ups effortless.</span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Smart Upselling &amp; Cross-Selling:</span> Suggests related products, services, or subscription plans to maximize your revenue.
            </span>
          </div>
        </div>
      <p></p>
    ...
    <img src="https://raw.githubusercontent.com/creativetimofficial/public-assets/refs/heads/master/gali/solutions/sales-growth-fashion.jpg" alt="delive instant answers" class="max-w-full h-auto rounded-lg object-center object-cover border border-neutral-200"></img>
  </div>
  <div class="container mx-auto grid items-center gap-y-8 md:grid-cols-2">
    ...
    <div class="w-full items-center p-12">
      ...
      <h3 class="font-sans antialiased font-extrabold text-2xl md:text-3xl lg:text-4xl text-neutral-950 mb-2">
        Effortless Sharing Across Your Network</h3>
      <p class="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500">Once you create your Agent, you`ll have access to a link that can be shared across multiple platforms.
        </p><div class="flex flex-col space-y-4">
          <div class="flex items-start">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Share Your AI Assistant with a Click:</span> Use your unique GaliChat link in social media posts, emails, or SMS to engage customers instantly.</span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Perfect for Business Communities &amp; Networking:</span> Share your AI agent in Facebook groups, LinkedIn, and industry forums to answer questions and generate interest.</span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">No Extra Apps Needed:</span> Clients and leads can interact with your AI assistant without installing anything, ensuring seamless engagement.</span>
          </div>
        </div>
      <p></p>
      <div class="mb-6"></div>
...
<section class="py-16 bg-neutral-100">
  <div class="h-max rounded p-6 w-full m-0 text-center">
    <h1 class="font-sans antialiased font-extrabold text-2xl md:text-3xl lg:text-4xl text-neutral-950 mb-1 mt-4">
      The Easiest Setup</h1>
    <p class="font-sans antialiased text-base md:text-lg text-neutral-500 max-w-3xl [text-wrap:balance] mx-auto mb-4">
      
Just enter your store URL, upload your website URL or product details, personalize your AI assistant, and add a simple code snippet to your website. That`s all!</p>
  </div>
