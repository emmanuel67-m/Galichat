  ...
  <div class="w-full h-full flex-grow flex flex-col">
    ...
    <div class="container h-full relative flex-grow flex justify-center flex-col items-center text-center z-10 py-8 md:py-16 lg:py-24 mx-auto">
      ...
      <h1 class="font-sans antialiased font-extrabold text-3xl md:text-4xl lg:text-5xl text-white mt-6 mb-4 !leading-[1.125]">
        Best AI Agent for Web3 &amp; Crypto</h1>
      <p class="font-sans antialiased text-base md:text-lg lg:text-xl text-white/80 font-normal max-w-4xl mx-auto">Whether you`re running an NFT marketplace, a DeFi platform, or a DAO, GaliChat ensures seamless engagement with your audience, helping you grow your community</p>
    ...
    <div class="mt-24 max-w-full md:w-full h-[550px] rounded-lg overflow-hidden mx-auto">
      <img class="absolute z-10 rounded-xl -translate-x-1/2 left-1/2 -mt-12 w-full max-w-[740px] lg:w-1/2 shadow-2xl" src="https://raw.githubusercontent.com/creativetimofficial/public-assets/refs/heads/master/gali/solutions/thumbs/ai-agent-web3-enthusiasts.jpg" alt="ai agent for web3 crypto"></img>
    </div>
  </div>
</header>
...
<section class="py-16 bg-neutral-950">
  <div class="container mx-auto mb-12 text-center">
    ...
    <h2 class="font-sans antialiased font-bold text-2xl md:text-3xl lg:text-4xl text-white my-4">
      Effortless AI Engagement for Web3 Projects</h2>
    <p class="font-sans antialiased text-base md:text-lg max-w-2xl text-white/60 mx-auto">Managing user inquiries, guiding new visitors, and promoting your Web3 offerings can be challenging. GaliChat simplifies the process by handling interactions in real time. </p>
  </div>
  <div class="container mx-auto grid grid-cols-1 gap-12 md:grid-cols-2">
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent text-center">
      ...
      <div class="w-full h-max rounded p-0">
        ...
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">Skip the complicated setup—simply add a small script to your Web3 website, and GaliChat instantly starts engaging with your visitors.</p>
      </div>
    </div>
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
      ...
      <div class="w-full h-max rounded p-0 text-center">
        <h6 class="font-sans antialiased font-bold text-base md:text-lg lg:text-xl text-white mb-2">
          Flexible Training Options</h6>
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">Train your AI assistant with FAQs, whitepapers, tokenomics details, and smart contract information to provide accurate and context-aware responses.</p>
      </div>
    </div>
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
      <div class="h-max rounded m-2 w-full mx-0 mt-0 mb-4">
      ...
      <div class="w-full h-max rounded p-0 text-center">
        <h6 class="font-sans antialiased font-bold text-base md:text-lg lg:text-xl text-white mb-2">
          Customizable AI Experience</h6>
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">Personalize GaliChat`s tone, responses, and engagement style to match your brand identity, creating a more immersive and authentic experience for your users.</p>
      </div>
    </div>
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background/10 border-transparent shadow-transparent">
      <div class="h-max rounded m-2 w-full mx-0 mt-0 mb-4">
      ...
      <div class="w-full h-max rounded p-0 text-center">
        ...
        <p class="font-sans antialiased text-base block text-white/60 max-w-sm mx-auto">Provide instant, precise information about your project, reducing confusion and improving user retention.</p>
      </div>
</div></div></section>
...
<section class="py-16 space-y-16 bg-neutral-100">
  <div class="container mx-auto grid items-center gap-y-8 md:grid-cols-2">
    ...
    <div class="w-full items-center p-12">
      ...
      <p class="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500">GaliChat goes beyond support—it actively drives engagement and guides visitors toward key actions.
          ...
          <div class="flex items-start">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Whitelist &amp; Early Access:</span> Help users understand how to join your whitelist, participate in token sales, or secure early NFT drops.</span>
          </div>
          <div class="flex items-start mb-4">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Airdrops &amp; Rewards: </span> Provide real-time details about upcoming airdrops, reward distributions, and staking benefits.</span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">DAO &amp; Governance Support: </span> Educate visitors about voting rights, governance proposals, and how to get involved in your community.</span>
          </div>
        </div>
      <p></p>
      <div class="mb-6"></div>
  ...
  <div class="container mx-auto grid items-center gap-y-8 md:grid-cols-2">
    <div class="w-full items-center p-12 md:row-start-1 row-start-2">
      ...
      <h3 class="font-sans antialiased font-extrabold text-2xl md:text-3xl lg:text-4xl text-neutral-950 mb-2">
        Capture Leads &amp; Maximize Conversions</h3>
      <p class="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500"> GaliChat helps you turn website visitors into engaged community members.
        </p><div class="flex flex-col space-y-4">
          <div class="flex items-start">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Automated Lead Collection: </span>Gather email addresses, wallet details, and social handles for future outreach.</span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Frictionless Sales Funnel:</span> Guide users to purchase tokens, mint NFTs, or subscribe to exclusive memberships with minimal steps.
            </span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Targeted Promotions &amp; Upselling: </span> Offer incentives like discounted minting fees, staking rewards, or bundled NFT packages.</span>
          </div>
        </div>
      <p></p>
      <div class="mb-6"></div>
  ...
  <div class="container mx-auto grid items-center gap-y-8 md:grid-cols-2">
    <img src="https://raw.githubusercontent.com/creativetimofficial/public-assets/refs/heads/master/gali/solutions/share-ai-agent.jpg" alt="web 3 community agent" class="max-w-full h-auto w-full rounded-lg object-center object-cover border border-neutral-200"></img>
    <div class="w-full items-center p-12">
      <div class="border shadow-sm overflow-hidden bg-neutral-900 border-neutral-950 shadow-neutral-950/25 w-12 h-12 text-white mb-8 rounded-lg grid place-items-center p-2">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
      ...
      <h3 class="font-sans antialiased font-extrabold text-2xl md:text-3xl lg:text-4xl text-neutral-950 mb-2">
        Share GaliChat Across Your Community</h3>
      <p class="font-sans antialiased text-base md:text-lg mb-4 text-neutral-500">GaliChat makes it effortless to connect with users across multiple platforms.
        </p><div class="flex flex-col space-y-4">
          <div class="flex items-start">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Instant Access, No Installation:</span> Share your AI assistant`s link via social media, Discord, Twitter, or Telegram without any downloads required.</span>
          </div>
          <div class="flex items-start mb-4">
            <div class="rounded-full bg-neutral-800 p-1 mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span class="text-neutral-500"><span class="font-semibold text-neutral-900">Effortless Community Engagement:</span> Use GaliChat to answer questions in crypto forums, AMAs, and Web3 community spaces.</span>
          </div>
        </div>
      <p></p>
      <div class="mb-6"></div>
...
<section class="py-16 bg-neutral-100">
  <div class="h-max rounded p-6 w-full m-0 text-center">
    <h1 class="font-sans antialiased font-extrabold text-2xl md:text-3xl lg:text-4xl text-neutral-950 mb-1 mt-4">
      Quick &amp; Simple Setup</h1>
    <p class="font-sans antialiased text-base md:text-lg text-neutral-500 max-w-3xl [text-wrap:balance] mx-auto mb-4">
      
    Just enter your website URL, upload your project details and FAQs, customize your AI assistant, and add a single code snippet. That`s it—fast, seamless, and hassle-free.</p>
  </div>
